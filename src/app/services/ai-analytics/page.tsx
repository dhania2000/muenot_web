...
import { BarChart3, CheckCircle, ArrowRight, Sparkles, ArrowLeft } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Comprehensive KPIs to measure and track AI model performance"
    },
    {
      title: "Quality Reports",
      description: "Detailed analytics on data quality and model accuracy"
    },
    {
      title: "Trend Analysis",
      description: "Identify patterns and trends in model behavior over time"
    },
    {
      title: "ROI Tracking",
      description: "Measure the business impact and return on AI investments"
    },
    {
      title: "Model Comparison",
      description: "Side-by-side analysis of different models and approaches"
    },
    {
      title: "Drift Detection",
      description: "Monitor and alert on model degradation and data drift"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Data-driven insights to measure and improve AI performance. Transform
              metrics into actionable intelligence for your AI initiatives.
            </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Powerful analytics tools to monitor, measure, and optimize your AI systems
            </p>
          </motion.div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Get actionable insights to continuously improve your AI systems and maximize ROI
            </p>
            <Link href="/#cta-section">
