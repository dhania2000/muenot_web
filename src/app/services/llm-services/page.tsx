...
import { Sparkles as SparklesIcon, CheckCircle, ArrowRight, Sparkles, ArrowLeft } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Craft optimized prompts that maximize LLM performance and accuracy"
    },
    {
      title: "Fine-tuning Data",
      description: "Custom datasets designed for fine-tuning large language models"
    },
    {
      title: "Response Rating",
      description: "Human evaluation of LLM outputs for quality and relevance"
    },
    {
      title: "Safety Evaluation",
      description: "Comprehensive testing to ensure safe and responsible AI outputs"
    },
    {
      title: "Hallucination Detection",
      description: "Identify and mitigate false or misleading model-generated content"
    },
    {
      title: "Benchmark Testing",
      description: "Rigorous performance testing against industry-standard benchmarks"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Specialized services for large language model development. From prompt
              engineering to safety evaluation, we help you build better LLMs.
            </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Comprehensive LLM
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-indigo-400"> Support</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Full-stack services to develop and optimize large language models
            </p>
          </motion.div>
      ...
      <section className="relative py-24">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Build Next-Generation LLMs
            </h2>
            <p className="text-muted-foreground text-lg mb-8">
              Partner with experts who understand the intricacies of large language model development
            </p>
            <Link href="/#cta-section">
