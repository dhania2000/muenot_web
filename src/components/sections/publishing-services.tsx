          ...
          {publishingCategories.map((category, index) => (
            ...
            >
              <Link href={category.href} className="block h-full">
                <div className="relative h-full p-6 rounded-2xl bg-gradient-to-b from-secondary/50 to-secondary/20 border border-border hover:border-pink-500/30 transition-all duration-300 cursor-pointer">
                  {/* Glow */}
                  <div
                    className={cn(
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-white group-hover:text-pink-300 transition-colors flex items-center gap-2 flex-1">
                      {category.title}
